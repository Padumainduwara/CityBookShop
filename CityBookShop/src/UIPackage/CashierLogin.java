...
public class CashierLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cashier Login Interface");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtCashierId, javax.swing.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (txtCashierId.getText().isEmpty() || txtPassword.getText().isEmpty() )
        {
        ...
        else 
        {
            ...
            CashierClass Mn = new CashierClass(cashierId, password);
            if (Mn.validateLogin()) {
                JOptionPane.showMessageDialog(null,"Login Successfull" ,"Login", 
                        JOptionPane.INFORMATION_MESSAGE);
            
               CashierInter Mi = new CashierInter();            
               Mi.show();
               this.dispose();
            }
            else 
            {
                JOptionPane.showMessageDialog(null,"Login Fail" ,"Login"

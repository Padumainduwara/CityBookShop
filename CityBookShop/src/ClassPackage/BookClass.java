...
public class BookClass {
    ...
    FileSystem fs = new FileSystem("Book.txt");
    ...
    public BookClass(String BookId, String BookName, String AuthorName, String Category, String Price) {
        this.BookId = BookId;
     ...
     public boolean addBooks() {
       ...
       public String viewAllBooks () 
      {
        ...
        try {
            ...
            {     
                words = books.split(" ");
                allBooks = allBooks + words[0] + "\t" + words[1] + "\t" + words[2] + "\t" + words[3] + "\t" + words[4] +"\n";             
            ...
            while ((books = bk.readLine()) != null) {            
                ...
                for (String word : words) {
                    if (word.equals(BookId)) 
                    {
                        ...
                        this.setCategory(words[3]);
                        this.setAuthorName(words[4]);
